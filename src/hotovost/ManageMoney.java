package hotovost;
/**
 * Functional interface pouívanı na metódu s lambda vırazom
 * Obsahuje jednu default method 
...
public interface ManageMoney {
	...
	/**
	 * Default metóda spraví to, e ak by bolo na pošte menej peòazí, tak sa peniaze navıšia
	 * Môe sa to sta pri vyplácaní vıplaty zamestnancom
