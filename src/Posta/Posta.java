...
/**
 * @deprecated priebehalo tu konzolové testovanie, keïže sa používa GUI, tento
 *             main sa už nepoužíva
 */
public class Posta {
	...
	public static void main(String[] args) throws ZleUdajeException {
		 ...
		 * veduci1.add(dorucovatel1); veduci1.add(pracovnik2); veduci1.add(pracovnik1);
		 * veduci1.dostanVyplatu(); //vsetci dostanu vyplatu veduci1.info(); Znamky
		 * znamkyT2 = new Znamky("ZnamkyT2", 100, "T2"); Znamky znamkyT1 = new
		 * Znamky("ZnamkyT1", 100, "T1"); Casopisy GEO = new Casopisy("Geo", 5, "GEO");
		 ...
		 * System.out.println(GEO.getPocet()); System.out.println(stavHotovosti);
		 */
		/*
		 * ManazerHotovosti manazer = new ManazerHotovosti(); ManageMoney pridaj =
		 * (double stavHotovosti, double suma) -> stavHotovosti = stavHotovosti + suma;
